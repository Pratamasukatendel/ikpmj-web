      ...
      <div className="w-screen">
        ...
        <div className="h-screen bg-gray-100 p-7">
          <div className=" h-auto w-auto">
            <h1 className="text-2xl font-bold mb-8 text-gray-500">Anggota</h1>
            <ul className="flex gap-10 mb-16">
              <li className="text-gray-600">Semua Anggota</li>
            ...
            <div className="flex justify-between">
              ...
              <button
                type="button"
                className="rounded-md bg-green-500 px-3 py-2 text-sm font-semibold text-white shadow-xs ring-1 ring-gray-300 ring-inset hover:bg-green-600 flex justify-around items-center gap-2"
              >
                <svg
