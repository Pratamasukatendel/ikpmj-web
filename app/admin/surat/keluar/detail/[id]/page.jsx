// app/admin/surat/keluar/detail/[id]/page.jsx
"use client";
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const fakeData = {
          ...
          tujuan: `Dinas Pendidikan DIY (ID: ${id})`,
          perihal: `Perihal Detail Surat Keluar ${id}: Pemberitahuan Kegiatan`,
          isi_surat: `Dengan hormat, kami memberitahukan bahwa IKPMJ akan mengadakan kegiatan bakti sosial pada tanggal 15 Agustus 2025. Mohon dukungan dan partisipasinya. Demikian surat ini kami sampaikan. Hormat kami, Ketua IKPMJ.`,
          jenis_surat: id % 2 === 0 ? "Pemberitahuan" : "Undangan",
        ...
        <div className="p-7 flex-1 flex flex-col items-center justify-center">
          <div className="w-full max-w-3xl">
            <h1 className="text-3xl font-bold text-gray-800 text-center mb-8">
              Detail Surat Keluar{" "}
              <span className="text-teal-600">ID: {id}</span>
            </h1>
            <div className="bg-white shadow-lg rounded-lg p-8 border border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 text-gray-700">
                ...
                <div className="col-span-full">
                  ...
                  <p className="text-lg font-bold">{suratData.tujuan}</p>
                </div>
                <div className="col-span-full">
                  <p className="text-sm font-medium text-gray-500">
                    Perihal / Judul:
                ...
                <div className="col-span-full">
                  ...
                  <p className="text-base bg-gray-50 p-3 rounded-md border border-gray-200 whitespace-pre-wrap">
                    {suratData.isi_surat || "Tidak ada isi surat."}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">
